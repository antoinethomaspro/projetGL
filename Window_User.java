...
public class Window_User extends JFrame implements ActionListener{
	...
	};*///eviter la repetition de la fenetre
	...
	public Window_User() {
		...
		done.addActionListener(this);//ecouter cet evenment inserer le ticket par le button done
	}
	
	
	  public static void main(String[] args) throws Exception {
	    	Window_User koko = new Window_User();
	...
	private void insererT() {
		...
		String categorie = importance.getSelectedItem().toString();//使得Box内容被获得  obtenir le contenu du box
		String priorite = boxType.getSelectedItem().toString();
